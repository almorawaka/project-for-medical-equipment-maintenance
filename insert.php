...
<p><input type="text" name="hospital_name" placeholder="Enter Hospital Name" required /></p>
<p><input type="text" name="h_type" placeholder="Type" required /></p>
<p><input type="text" name="equipment_name" placeholder="Equipment Name" required /></p>
<p><input type="text" name="equipment_make" placeholder="Equipment Make" required /></p>
<p><input type="text" name="equipment_model" placeholder="Equipment Model" required /></p>
