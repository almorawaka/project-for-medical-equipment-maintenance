...
<!--<form name="registration" action="" method="post">-->
 ...
 <div class="col-12">
<input type="email" name="email" placeholder="Email" required />  </div> <br /><br />
 <div class="col-12">
<input type="password" name="password" placeholder="Password" required />  </div> <br /><br />
 <div class="col-12">
<input type="phone_no" name="phone_no" placeholder="phone_no" required />  </div> <br /><br />
 <div class="col-12">
<input type="staff_id" name="staff_id" placeholder="staff_id" required />  </div> <br /><br />
 <div class="col-12">
<input type="submit" name="submit" value="Register" />  </div> <br /><br />
</form>
